...
COPY = {
    ...
    'earn-dataset': dict(niche='JSON + TXT · 186+ endpoints', num='28', label='listings', desc='28 open Superteam Earn listings with full description HTML plus 186+ reverse-engineered API routes, harvested from the live superteam.fun API in September 2026.', alt=None),
    'nfl-dataset': dict(niche='CSV · 1999-2026', num='7,548', label='games', desc='Every NFL game from the 1999 season through the full 2026 schedule: 7,548 rows with closing spreads, totals, moneylines, scores and game conditions in normalized CSV columns.', alt=None),
    ...
    'housing-pack': dict(niche='CSV · 14 tables', num='68,209', label='rows', desc='Fair market rents for 51,871 ZIP codes and 3,229 counties paired with Eurostat unemployment and house-price tables: 68,209 rows across 14 tables, one frozen 2026-09-10 snapshot.', alt=None),
